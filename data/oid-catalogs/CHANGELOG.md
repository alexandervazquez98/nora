...
|----------|--------|--------|-----|
| `frequency` | `1.3.6.1.4.1.161.19.3.1.1.2.0` | `1.3.6.1.4.1.161.19.3.1.10.1.1` | Re-pointed from deprecated `rfFreqCarrier` (SYNTAX `{ wired(0) }` only) to current `radioFreqCarrier` |
| `migrateCarrierFrequency` | `1.3.6.1.4.1.161.19.3.1.1.2.0` | `1.3.6.1.4.1.161.19.3.1.10.1.1` | Same correction |
| `migratePriorCarrierFrequency` | `1.3.6.1.4.1.161.19.3.1.1.2.0` | `1.3.6.1.4.1.161.19.3.1.10.1.1` | Same correction |

**What was added (every firmware baseline)**:

| OID name | OID | Source | Used by |
|----------|-----|--------|---------|
| `radioFreqCarrier` | `1.3.6.1.4.1.161.19.3.1.10.1.1` | WHISP-APS-MIB `whispApsRFConfigRadioEntry 1` (radioIndex=1) | Canonical SET target for `snmp_migrate_radio_frequency` |
